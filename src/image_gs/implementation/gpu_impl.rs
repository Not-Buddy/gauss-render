...
impl ImageGS {
    ...
    pub async fn fit_to_image_gpu(&mut self, target_path: &str, iterations: usize) -> Result<(), Box<dyn Error>> {
        ...
        let renderer = super::super::gpu_render::GpuRenderer::new().await?;
        ...
        for iter in 0..iterations {
            ...
            if iter % 10 == 0 {
                ...
                println!("    Stagnation = {}, Momentum = {:.4}, Loss_Factor = {:.2}", 
                         stagnation_count, loss_momentum, loss_adaptive_factor);
